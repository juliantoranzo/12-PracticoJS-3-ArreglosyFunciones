...
while (true) {
  let ciudad = prompt(
    "Ingrese el nombre de una ciudad (o presione Cancelar para finalizar):"
  );
  if (ciudad === null) {
    break;
  } else {
...
document.write("<ul>");
document.write(
  "<li> Elementos de la primer posición: " + ciudades[0] + "</li>"
);
document.write(
  "<li> Elementos de la tercer posición: " + ciudades[2] + "</li>"
);
document.write(
  "<li> Elementos de la última posición: " +
...
document.write("<ul>");
document.write(
  "<li> Elemento de la segunda posición: " + ciudades[1] + "</li>"
);
...
document.write("<li> Elemento: Paris </li>");
document.write("</ul>");
